    ...
    db['Job'].create(
      {
        ...
        JobResponsibilities: "<ul><li><ul><li>Create new customers base.</li><li>To make cold/sales calls &amp; liaise with clients for meetings.</li><li>Preparation of presentation to client for sales pitches.</li><li>Close supervision of site progress to ensure quality of work with contractors.</li><li>Good knowledge of schedule procedures for co-ordination of sub-contractors.</li><li>Ability to provide documentation of project, eg. Emails, correspondences, quotations, delivery orders/ purchase orders and final costing for project claims.</li><li>Cost Evaluation, preparation of costing, post contract administration.</li><li>Prepare Tender Documents.</li><li>To prepare progressive claim invoices.</li><li>Procurement of necessary materials.</li><li>To attend site meeting prior to project implementation.</li><li>Prepare works instructions/order and submit drawings to main contractors and building management for submission works.</li><li>Project schedule planning and monitoring of delivery schedule.</li><li>Ensure that deadline for completion of projects.</li><li>Ensure workmanship of sub-contractors are met and QC check with proper handover upon completion of project to the client.</li><li>To supervise/coordinate onsite installation works with contractors.</li><li>Ensure prompt payments from Clients.</li><li>Perform any other related duties as assigned by Sales Manager and/or Director.</li><li>Ensure that the system is updated with the latest information.</li><li>Assist in the maintenance of database of clienteles.</li><li>Manage and check for any erroneous certificates of attendance that was issued.</li><li>Other ad-hoc duties.</li><li></li></ul></li></ul>",
    ...
    db['Job'].create(
      {
        ...
        JobResponsibilities: "<ul><li><ul><li><ul><li>Conduct 1-to-1 and group classes from lesson planning, lecture, demonstration, and relevant class exercises/activities</li><li>Assist the students in attaining their objectives and goals for academic improvement</li><li>Evaluate the students\' progress through regular standard feedback processes</li><li>Inspire and motive students to excel</li></ul></li></ul></li></ul>",
